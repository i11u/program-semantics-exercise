...
module MenhirBasics = struct
  ...
  type token = 
    | LT
    | INTV of (
# 6 "bin/compare_nat_1/parser.mly"
       (int)
# 16 "bin/compare_nat_1/parser.ml"
  )
...
# 1 "bin/compare_nat_1/parser.mly"
  
  open Syntax

# 27 "bin/compare_nat_1/parser.ml"
...
let _menhir_action_1 =
  fun n1 n2 ->
    (
# 14 "bin/compare_nat_1/parser.mly"
                     ( LessThanExp (n1, n2) )
# 39 "bin/compare_nat_1/parser.ml"
     : (Syntax.judgement))
