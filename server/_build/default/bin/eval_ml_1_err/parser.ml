...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LPAREN
    | INTV of (
# 10 "bin/eval_ml_1_err/parser.mly"
       (int)
# 23 "bin/eval_ml_1_err/parser.ml"
  )
    | IF
    | FALSE
    | EVALTO
...
# 1 "bin/eval_ml_1_err/parser.mly"
  
open Syntax

# 39 "bin/eval_ml_1_err/parser.ml"
...
let _menhir_action_01 =
  fun i ->
    (
# 39 "bin/eval_ml_1_err/parser.mly"
         ( ILit i )
# 114 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_02 =
  fun () ->
    (
# 40 "bin/eval_ml_1_err/parser.mly"
       ( BLit true )
# 122 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_03 =
  fun () ->
    (
# 41 "bin/eval_ml_1_err/parser.mly"
        ( BLit false )
# 130 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_04 =
  fun e ->
    (
# 42 "bin/eval_ml_1_err/parser.mly"
                       ( e )
# 138 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_05 =
  fun c e t ->
    (
# 43 "bin/eval_ml_1_err/parser.mly"
                                    ( IfExp (c, t, e) )
# 146 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_06 =
  fun e ->
    (
# 23 "bin/eval_ml_1_err/parser.mly"
           ( e )
# 154 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_07 =
  fun l r ->
    (
# 26 "bin/eval_ml_1_err/parser.mly"
                       ( BinOp (Lt, l, r) )
# 162 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_08 =
  fun e ->
    (
# 27 "bin/eval_ml_1_err/parser.mly"
           ( e )
# 170 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_09 =
  fun l r ->
    (
# 35 "bin/eval_ml_1_err/parser.mly"
                       ( BinOp (Mult, l, r) )
# 178 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_10 =
  fun e ->
    (
# 36 "bin/eval_ml_1_err/parser.mly"
          ( e )
# 186 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_11 =
  fun l r ->
    (
# 30 "bin/eval_ml_1_err/parser.mly"
                        ( BinOp (Plus, l, r) )
# 194 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_12 =
  fun l r ->
    (
# 31 "bin/eval_ml_1_err/parser.mly"
                         ( BinOp (Minus, l, r) )
# 202 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_13 =
  fun e ->
    (
# 32 "bin/eval_ml_1_err/parser.mly"
          ( e )
# 210 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.exp))

let _menhir_action_14 =
  fun e i ->
    (
# 17 "bin/eval_ml_1_err/parser.mly"
                       ( EvalExp (e, ILit i) )
# 218 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.judgement))

let _menhir_action_15 =
  fun e ->
    (
# 18 "bin/eval_ml_1_err/parser.mly"
                     ( EvalExp (e, BLit true) )
# 226 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.judgement))

let _menhir_action_16 =
  fun e ->
    (
# 19 "bin/eval_ml_1_err/parser.mly"
                      ( EvalExp (e, BLit false) )
# 234 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.judgement))

let _menhir_action_17 =
  fun e ->
    (
# 20 "bin/eval_ml_1_err/parser.mly"
                      ( EvalExp (e, Error) )
# 242 "bin/eval_ml_1_err/parser.ml"
     : (Syntax.judgement))
