...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LBRACKET
    | INTV of (
# 13 "bin/eval_ml_4/parser.mly"
       (int)
# 28 "bin/eval_ml_4/parser.ml"
  )
    | IN
    | IF
    | ID of (
# 12 "bin/eval_ml_4/parser.mly"
       (Syntax.id)
# 35 "bin/eval_ml_4/parser.ml"
  )
    | FUN
    | FALSE
    | EVALTO
...
let _menhir_action_01 =
  fun i ->
    (
# 74 "bin/eval_ml_4/parser.mly"
         ( ILit i )
# 242 "bin/eval_ml_4/parser.ml"
     : (Syntax.exp))
...
let _menhir_action_23 =
  fun e v x y ->
    (
# 42 "bin/eval_ml_4/parser.mly"
                                                                              ( RecProcV (x, y, e, ref v) )
