...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LBRACKET
    | INTV of (
# 15 "bin/eval_ml_5/parser.mly"
       (int)
# 31 "bin/eval_ml_5/parser.ml"
  )
    | IN
    | IF
    | ID of (
# 14 "bin/eval_ml_5/parser.mly"
       (Syntax.id)
# 38 "bin/eval_ml_5/parser.ml"
  )
    | FUN
    | FALSE
    | EVALTO
...
# 1 "bin/eval_ml_5/parser.mly"
  
open Syntax

# 58 "bin/eval_ml_5/parser.ml"
...
let _menhir_action_01 =
  fun i ->
    (
# 99 "bin/eval_ml_5/parser.mly"
         ( ILit i )
# 270 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_02 =
  fun i ->
    (
# 100 "bin/eval_ml_5/parser.mly"
       ( Var i )
# 278 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_03 =
  fun () ->
    (
# 101 "bin/eval_ml_5/parser.mly"
       ( BLit true )
# 286 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_04 =
  fun () ->
    (
# 102 "bin/eval_ml_5/parser.mly"
        ( BLit false )
# 294 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_05 =
  fun e ->
    (
# 103 "bin/eval_ml_5/parser.mly"
                       ( e )
# 302 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_06 =
  fun () ->
    (
# 104 "bin/eval_ml_5/parser.mly"
                    ( NilExp )
# 310 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_07 =
  fun e1 e2 ->
    (
# 95 "bin/eval_ml_5/parser.mly"
                      ( AppExp (e1, e2) )
# 318 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_08 =
  fun e ->
    (
# 96 "bin/eval_ml_5/parser.mly"
          ( e )
# 326 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_09 =
  fun e1 e2 ->
    (
# 66 "bin/eval_ml_5/parser.mly"
                            ( ConsExp (e1, e2) )
# 334 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_10 =
  fun e ->
    (
# 58 "bin/eval_ml_5/parser.mly"
            ( e )
# 342 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_11 =
  fun e ->
    (
# 59 "bin/eval_ml_5/parser.mly"
             ( e )
# 350 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_12 =
  fun e ->
    (
# 60 "bin/eval_ml_5/parser.mly"
            ( e )
# 358 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_13 =
  fun e ->
    (
# 61 "bin/eval_ml_5/parser.mly"
           ( e )
# 366 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_14 =
  fun e ->
    (
# 62 "bin/eval_ml_5/parser.mly"
           ( e )
# 374 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_15 =
  fun e ->
    (
# 63 "bin/eval_ml_5/parser.mly"
              ( e )
# 382 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_16 =
  fun e x ->
    (
# 69 "bin/eval_ml_5/parser.mly"
                        ( FunExp (x, e) )
# 390 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_17 =
  fun c e t ->
    (
# 72 "bin/eval_ml_5/parser.mly"
                                    ( IfExp (c, t, e) )
# 398 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_18 =
  fun l r ->
    (
# 82 "bin/eval_ml_5/parser.mly"
                       ( BinOp (Lt, l, r) )
# 406 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_19 =
  fun e ->
    (
# 83 "bin/eval_ml_5/parser.mly"
           ( e )
# 414 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_20 =
  fun e1 e2 x ->
    (
# 78 "bin/eval_ml_5/parser.mly"
                                 ( LetExp (x, e1, e2) )
# 422 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_21 =
  fun e1 e2 x y ->
    (
# 79 "bin/eval_ml_5/parser.mly"
                                                    ( LetRecExp (x, y, e1, e2) )
# 430 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_22 =
  fun l r ->
    (
# 91 "bin/eval_ml_5/parser.mly"
                         ( BinOp (Mult, l, r) )
# 438 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_23 =
  fun e ->
    (
# 92 "bin/eval_ml_5/parser.mly"
            ( e )
# 446 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_24 =
  fun e1 e2 e3 x y ->
    (
# 75 "bin/eval_ml_5/parser.mly"
                                                                                           ( MatchExp (e1, e2, x, y, e3) )
# 454 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_25 =
  fun l r ->
    (
# 86 "bin/eval_ml_5/parser.mly"
                        ( BinOp (Plus, l, r) )
# 462 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_26 =
  fun l r ->
    (
# 87 "bin/eval_ml_5/parser.mly"
                         ( BinOp (Minus, l, r) )
# 470 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_27 =
  fun e ->
    (
# 88 "bin/eval_ml_5/parser.mly"
          ( e )
# 478 "bin/eval_ml_5/parser.ml"
     : (Syntax.exp))

let _menhir_action_28 =
  fun e v x ->
    (
# 40 "bin/eval_ml_5/parser.mly"
                                                                  ( ProcV (x, e, v) )
# 486 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_29 =
  fun e v x y ->
    (
# 43 "bin/eval_ml_5/parser.mly"
                                                                              ( RecProcV (x, y, e, v) )
# 494 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_30 =
  fun v x ->
    (
# 53 "bin/eval_ml_5/parser.mly"
                  ( (x, v) )
# 502 "bin/eval_ml_5/parser.ml"
     : (string * Syntax.exval))

let _menhir_action_31 =
  fun i ->
    (
# 29 "bin/eval_ml_5/parser.mly"
         ( IntV i )
# 510 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_32 =
  fun () ->
    (
# 30 "bin/eval_ml_5/parser.mly"
       ( BoolV true )
# 518 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_33 =
  fun () ->
    (
# 31 "bin/eval_ml_5/parser.mly"
        ( BoolV false )
# 526 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_34 =
  fun v ->
    (
# 32 "bin/eval_ml_5/parser.mly"
              ( v )
# 534 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_35 =
  fun v ->
    (
# 33 "bin/eval_ml_5/parser.mly"
                 ( v )
# 542 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_36 =
  fun () ->
    (
# 34 "bin/eval_ml_5/parser.mly"
                    ( NilV )
# 550 "bin/eval_ml_5/parser.ml"
     : (Syntax.exval))

let _menhir_action_37 =
  fun hd tl ->
    (
# 48 "bin/eval_ml_5/parser.mly"
                                ( hd::tl )
# 558 "bin/eval_ml_5/parser.ml"
     : ((string * Syntax.exval) list))

let _menhir_action_38 =
  fun v ->
    (
# 49 "bin/eval_ml_5/parser.mly"
              ( v::[] )
# 566 "bin/eval_ml_5/parser.ml"
     : ((string * Syntax.exval) list))

let _menhir_action_39 =
  fun () ->
    (
# 50 "bin/eval_ml_5/parser.mly"
  ( [] )
# 574 "bin/eval_ml_5/parser.ml"
     : ((string * Syntax.exval) list))

let _menhir_action_40 =
  fun e v vl ->
    (
# 24 "bin/eval_ml_5/parser.mly"
                                             ( EvalExp (vl, e, v) )
# 582 "bin/eval_ml_5/parser.ml"
     : (Syntax.judgement))
